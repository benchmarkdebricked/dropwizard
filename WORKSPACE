...
maven_jar(
    ...
    artifact = "com.fasterxml.jackson.module:jackson-module-jaxb-annotations:2.3.3",
    sha1 = "9dd2d0e5506417020b4541104a30d600f43727c1",
)
...
maven_jar(
    ...
    artifact = "com.fasterxml.jackson.jaxrs:jackson-jaxrs-json-provider:2.3.3",
    sha1 = "092cbd94379d98ce44c6d4cea8b1e3b376bbaf79",
)

maven_jar(
    name = "org_slf4j_slf4j_api",
    artifact = "org.slf4j:slf4j-api:1.7.6",
...
maven_jar(
    ...
    artifact = "com.fasterxml.jackson.jaxrs:jackson-jaxrs-base:2.3.3",
    sha1 = "fd26d46f2fe1e1b2c0a48ecf72994806df4ca2b3",
)
